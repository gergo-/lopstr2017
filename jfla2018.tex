...
Une variable est~\emph{vivante} à un point donné d'un programme si sa valeur a
ce point peut être utilisée plus tard.
...
% Gabriel: Ici il y a confusion entre "instruction" (f_S) et "position dans le code (livein(S)). Est-ce voulu/désirable ?
...
génération de code. Une nouvelle approche à l'analyse flot de données
